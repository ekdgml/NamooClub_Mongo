                    ...
                    <form action="${ctx}/management/redCard" method="get">
                        <table class="table table-striped table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td><input type="hidden" name="communityNo" value="${community.comNo}" /><a href="${ctx}/management/${community.comNo}/showUserInfo/${member.email}">${member.name}</a></td>
